...
class StockPicking(models.Model):
    ...
    invoice_id = fields.Many2one(string='Factura', copy=False)
    is_return_picking = fields.Boolean(string='Es devolucion', copy=False)
    ...
    #     print('todo_moves: ',todo_moves)
    #     todo_moves._action_done()
    #     self.write({'date_done': fields.Datetime.now()})
    #     print('ACTION DONE ENDDDDDDDDD')
    #     return True
